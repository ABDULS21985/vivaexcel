...
// Login Page
// =============================================================================
// Clean, centered card layout with email/password login, social providers,
// magic link option, and links to register / forgot password.
              ...
              {magicLinkSent ? (
                ...
                <form onSubmit={handleMagicLink} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-lg bg-[var(--primary)] text-white font-medium hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border border-dashed border-[var(--border)] text-[var(--muted-foreground)] text-sm hover:text-[var(--foreground)] hover:border-[var(--foreground)]/30 transition-colors"
                >
                  <Mail className="h-4 w-4" />
