    ...
    <section className="w-full py-16 lg:py-24 bg-neutral-50 dark:bg-neutral-900">
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            KTBlog is dedicated to helping developers, designers, and tech professionals level up their skills through expert-crafted content. We believe that accessible, high-quality knowledge is the foundation of innovation.
          </motion.p>
