...
// Blog Structured Data (SEO for blog platform)
export {
  ArticleStructuredData,
  BreadcrumbStructuredData,
  OrganizationStructuredData as BlogOrganizationStructuredData,
  WebSiteStructuredData,
  BlogHomeBreadcrumb,
  BlogPostBreadcrumb,
  BlogCategoryBreadcrumb,
  BlogAuthorBreadcrumb,
  generateBlogPostBreadcrumbs,
  generateCategoryBreadcrumbs,
  generateAuthorBreadcrumbs,
