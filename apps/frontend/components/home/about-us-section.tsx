        ...
        <section className="w-full py-24 bg-white">
            <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
                ...
                <p className="text-lg text-neutral-600 mb-16 leading-relaxed">
                    KTBlog is a technology and cybersecurity company operating across Doha and Nigeria, delivering mission-critical digital systems for governments, regulators, and enterprises in emerging and advanced markets.
                </p>
